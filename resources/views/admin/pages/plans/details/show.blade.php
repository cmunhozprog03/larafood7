...
<div class="row justify-content-center">
  <div class="col-md-8">
    <div class="w3-card-4">
      <header class="w3-dark-gray p-3"><h2>Detalhe: {{ $detail->name }}</h2></header>
        
      <ul class="mt-3">
        <li><strong>Nome:</strong> {{ $detail->name }}</li><br>
